...
export default function Main() {
    ...
    return (
        <>
            <div className="container-fluid main-container p-0" style={{ overflowY:'auto',width: '100%', height: '100vh', overflow: 'hidden', backgroundImage: 'linear-gradient(135deg, #09203f 10%, #537895 100%)' }}>
